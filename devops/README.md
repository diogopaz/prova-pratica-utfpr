...
```
DEPLOY_ENV=prod
DEPLOY_HOST=prova-pratica.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    prova-pratica.example.com:
      ansible_user: root
      host: prova-pratica
      hostname: prova-pratica.example.com
```
...
Deploy the stack defined in `devops/stacks/prova-pratica.example.com.yml` to the remote server with:
